...
struct TeslaLogo: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        path.addCurve(to: CGPoint(x: 0.64*width, y: 0.21*height), control1: CGPoint(x: 0.81544*width, y: 0.22463*height), control2: CGPoint(x: 0.77347*width, y: 0.21*height))
        ...
        path.addCurve(to: CGPoint(x: 0.044*width, y: 0.18312*height), control1: CGPoint(x: 0.17859*width, y: 0.28437*height), control2: CGPoint(x: 0.08906*width, y: 0.25134*height))
